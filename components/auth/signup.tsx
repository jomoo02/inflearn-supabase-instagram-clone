...
export default function SignUp({ setView }) {
  ...
  const [confirmationRequired, setConfirmationRequried] = useState(false);
    ...
    <div className="flex flex-col gap-4">
      <div className="pt-10 pb-6 px-10 w-full flex flex-col items-center justify-center max-w-lg border border-gray-400 gap-2 bg-white">
        ...
        <Button
          ...
          className="w-full py-1 text-md bg-yellow-700"
        >
          카카오 로그인
        </Button>
      </div>
